...
class _BoardingScreenState extends State<BoardingPage> {
  ...
  void initState() {
    ...
    _slides = [
      Slide("assets/images/Banner1.jpg", "Go Premium",
          "List your senior care home, facility or agency and get clients with ease."),
      Slide("assets/images/Banner2.jpg", "Be Presentable",
          "Showcase your services professionally and legibly \nto your clients"),
      Slide("assets/images/Banner3.jpg", "Advertise",
          "Advertise senior care homes or facilities for sale"),
    ];
